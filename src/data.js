...
export function getStageConfig(floor) {
...
export const rarityOrder = ["Common", "Rare", "Epic", "Legendary", "Mythic", "Ancient"];
...
export const slots = ["Weapon", "Helmet", "Armor", "Boots", "Ring", "Amulet", "Artifact"];
